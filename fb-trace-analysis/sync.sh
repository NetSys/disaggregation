...
while true; do
    ...
    echo $file
    ssh petergao@c33 "rm /root/disaggregation/fb-trace-analysis/$file"
    #scp -r /home/peter/disaggregation/fb-trace-analysis/*.py petergao@c33:/home/eecs/petergao/fb-trace-analysis
    rsync -rv --update --include='*/' --include='*.py' --exclude='*' /home/peter/disaggregation/fb-trace-analysis/* root@c127:/root/disaggregation/fb-trace-analysis
done
